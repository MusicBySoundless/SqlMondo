...
# First and foremost implement features that are a requirement of the project. 
...
#
# Proszę pamiętać, że nie jesteśmy doświadczeni w tej dziedzinie i nasz kod MOŻE i BĘDZIE zawierał wiele dziwacznie wymyślonych implementacji, błędów, robienia rzeczy na około itp.
